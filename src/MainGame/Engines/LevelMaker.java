...
import MainGame.*;
import MainGame.Background.Background;
import MainGame.Background.Lava;
import MainGame.Collidables.*;
import MainGame.Pickups.Cookie;
import MainGame.Pickups.Cube;
import MainGame.Pickups.Pie;
import MainGame.Pickups.Saucepan;
...
public class LevelMaker {
    ...
    public ArrayList<Sprite> getLevel1(){
        ...
        level.add(new Chandelier(2550, 70));
